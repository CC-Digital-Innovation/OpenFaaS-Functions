...
class TestPRTGRenameObject(unittest.TestCase):
    """Test the prtg-rename-object OpenFaaS function on the development
    instance of PRTG"""
    def setUp(self):
    ...
    def test_rename_success(self):
        """Test the success of the rename function with a valid payload."""
    ...
    def test_invalid_payload_too_long(self):
        """Test the rename function when passed an invalid payload with more
        than the 4 expected key-value pairs."""
    ...
    def test_invalid_payload_too_short(self):
        """Test the rename function when passed an invalid payload with less
        than the 4 expected key-value pairs."""
    ...
    def test_invalid_payload_not_a_dictionary(self):
        """Test the rename function when passed an invalid payload that is
        not in a JSON-formatted dictionary."""
    ...
    def test_invalid_api_key(self):
        """Test the rename function with an invalid API key."""
    ...
    def test_invalid_prtg_instance(self):
        """Test the rename function with an invalid PRTG instance URL."""
    ...
    def test_invalid_object_id(self):
        """Test the rename function with an invalid object ID."""
